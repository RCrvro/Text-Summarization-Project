...
#Prepare a tokenizer for summaries in training data
...
#Create Attention Block with Bahdanau Attention method
...
#Decoder setup
#This tensors will hold the states of the previous time step
